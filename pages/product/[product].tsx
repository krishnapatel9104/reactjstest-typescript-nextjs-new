...
const ItemDetailViewPage: NextPage<itemDetailViewPageProps> = ({ product }) => {
  console.log('item view component pass data : ', product);
  return <ItemDetailView product={product} />;
};
// const ItemDetailView: NextPage<itemDetailViewProps> = ({ product }) => {
...
export const getServerSideProps: GetServerSideProps = async context => {
  console.log('Context==>>', context.query, context.query.productId);
